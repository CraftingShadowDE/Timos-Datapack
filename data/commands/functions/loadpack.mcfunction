...
tellraw @a ["",{"text":"Info zu Timo's Datapack:","bold":true,"underlined":true,"color":"dark_red"},"\n",{"text":"Das Datapack wurde geladen und folgende Funktionen wurden aktiviert:","color":"red"},"\n",{"text":"volles Rezeptbuch, keepInventory, keine Babyzombies, neue Rezepte, durch Sneaken B�ume zum Wachsen bringen,","color":"red"},"\n",{"text":"Villager anleinen und noch weitere aktivierte und auch standardm��ig deaktivierte","color":"red"},"\n",{"text":"Funktionen. Um alle (de-)aktivierbaren Funktionen zu sehen, verwende bitte","color":"red"},"\n",{"text":"\"","color":"red"},{"text":"/function info","italic":true,"color":"red","clickEvent":{"action":"run_command","value":"/function info"},"hoverEvent":{"action":"show_text","contents":[{"text":"Klicke, um \"","color":"red"},{"text":"/function info","italic":true,"color":"red"},{"text":"\" auszuf�hren","color":"red"}]}},{"text":"\" oder \"","color":"red"},{"text":"/function minecraft:info","italic":true,"color":"red","clickEvent":{"action":"run_command","value":"/function minecraft:info"},"hoverEvent":{"action":"show_text","contents":[{"text":"Klicke, um \"","color":"red"},{"text":"/function minecraft:info","italic":true,"color":"red"},{"text":"\" auszuf�hren","color":"red"}]}},{"text":"\".","color":"red"},"\n",{"text":"Des weiteren kann man mit einem speziellen Buch im Survivalmode einfach","color":"red"},"\n",{"text":"ArmorStands bearbeiten. Informationen dazu kann man �ber \"","color":"red"},{"text":"/trigger as_help","italic":true,"color":"red","clickEvent":{"action":"run_command","value":"/trigger as_help"},"hoverEvent":{"action":"show_text","contents":[{"text":"Klicke, um \"","color":"red"},{"text":"/trigger as_help","italic":true,"color":"red"},{"text":"\" auszuf�hren","color":"red"}]}},{"text":"\"","color":"red"},"\n",{"text":"erhalten, Einstellungen k�nnen �ber \"","color":"red"},{"text":"/function armor_statues:admin","italic":true,"color":"red","clickEvent":{"action":"run_command","value":"/function armor_statues:admin"},"hoverEvent":{"action":"show_text","contents":[{"text":"Klicke, um \"","color":"red"},{"text":"/function armor_statues:admin","italic":true,"color":"red"},{"text":"\" auszuf�hren","color":"red"}]}},{"text":"\"","color":"red"},"\n",{"text":"aufgerufen werden, wenn man Admin-Rechte hat.","color":"red"}]
